...
type RelayLog struct {
	...
	PriceRuleID       int              `json:"price_rule_id,omitempty"`                   // 命中的实际价格规则 ID
	PriceSource       string           `json:"price_source,omitempty"`                    // rule 或 fallback
	PriceCurrency     string           `json:"price_currency,omitempty"`                  // 本次计费币种快照
	PriceSnapshot     string           `json:"price_snapshot,omitempty" gorm:"type:text"` // 本次计费价格快照
