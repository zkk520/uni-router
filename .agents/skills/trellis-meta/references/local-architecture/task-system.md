...
```bash
uv run python ./.trellis/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
uv run python ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
uv run python ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
uv run python ./.trellis/scripts/task.py create "<title>" --slug <slug>
uv run python ./.trellis/scripts/task.py start <task>
uv run python ./.trellis/scripts/task.py current --source
uv run python ./.trellis/scripts/task.py add-context <task> implement <file> <reason>
uv run python ./.trellis/scripts/task.py validate <task>
uv run python ./.trellis/scripts/task.py finish
uv run python ./.trellis/scripts/task.py archive <task>
```
